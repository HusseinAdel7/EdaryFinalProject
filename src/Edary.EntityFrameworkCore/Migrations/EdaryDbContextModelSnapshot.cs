...
namespace Edary.Migrations
{
    ...
    partial class EdaryDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Edary.Entities.Invoices.Invoice", b =>
                {
                    ...
                    b.Property<decimal?>("GrandTotal")
                        ...
                        .HasColumnType("decimal(18,2)")
                        .HasComputedColumnSql("(([TotalAmount]-[Discount])+[TaxAmount])", true);
                    ...
                    b.Property<string>("WarehouseId1")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Edary.Entities.Invoices.InvoiceDetail", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<decimal?>("TaxAmount")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("decimal(18,2)")
                        .HasComputedColumnSql("((([Quantity]*[UnitPrice]-[Discount])*[TaxRate])/(100))", true);
                    ...
                    b.Property<decimal?>("TotalWithTax")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("decimal(18,2)")
                        .HasComputedColumnSql("(([Quantity]*[UnitPrice]-[Discount])+(([Quantity]*[UnitPrice]-[Discount])*[TaxRate])/(100))", true);
                    ...
                    b.ToTable("InvoiceDetails", "Invoices");
                });

            modelBuilder.Entity("Edary.Entities.Items.Item", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<string>("UnitOfMeasureEn")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
            ...
            modelBuilder.Entity("Edary.Entities.Items.ItemPrice", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.ToTable("ItemPrices", "Items");
                });

            modelBuilder.Entity("Edary.Entities.JournalEntries.JournalEntry", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.ToTable("JournalEntries", "JournalEntries");
                });
            ...
            modelBuilder.Entity("Edary.Entities.MainAccounts.MainAccount", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<string>("ParentMainAccountId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<string>("TransferredToEn")
                        .HasMaxLength(250)
                        .HasColumnType("nvarchar(250)");
                    ...
                    b.HasIndex("ParentMainAccountId");

                    b.HasIndex("TenantId");

                    b.ToTable("MainAccounts", "Accounts");
                });

            modelBuilder.Entity("Edary.Entities.SubAccounts.SubAccount", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<string>("AccountCurrencyEn")
                        .IsRequired()
                        .HasMaxLength(10)
                        .HasColumnType("nvarchar(10)");
                    ...
                    b.Property<string>("AccountTypeEn")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
                    ...
                    b.Property<string>("StandardCreditRate")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
                    ...
                    b.ToTable("SubAccounts", "Accounts");
                });

            modelBuilder.Entity("Edary.Entities.Suppliers.Supplier", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Edary.Entities.Warehouses.Warehouse", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<string>("ManagerNameEn")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
            ...
            modelBuilder.Entity("Edary.Entities.Invoices.Invoice", b =>
                {
                    b.HasOne("Edary.Entities.JournalEntries.JournalEntry", null)
                        .WithMany()
                    ...
                    b.HasOne("Edary.Entities.Suppliers.Supplier", null)
                        .WithMany()
                        .HasForeignKey("SupplierId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Edary.Entities.Suppliers.Supplier", "Supplier")
                        .WithMany()
                        .HasForeignKey("SupplierId1")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Edary.Entities.Warehouses.Warehouse", null)
                        .WithMany()
                        .HasForeignKey("WarehouseId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Edary.Entities.Warehouses.Warehouse", "Warehouse")
                        .WithMany()
            ...
            modelBuilder.Entity("Edary.Entities.Invoices.InvoiceDetail", b =>
                {
                    b.HasOne("Edary.Entities.Invoices.Invoice", "Invoice")
                        .WithMany("InvoiceDetails")
                        .HasForeignKey("InvoiceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Edary.Entities.Items.Item", null)
                        .WithMany()
                        .HasForeignKey("ItemId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Edary.Entities.Items.Item", "Item")
                        .WithMany()
            ...
            modelBuilder.Entity("Edary.Entities.MainAccounts.MainAccount", b =>
                {
                    b.HasOne("Edary.Entities.MainAccounts.MainAccount", "ParentMainAccount")
                        .WithMany()
                        .HasForeignKey("ParentMainAccountId");

                    b.Navigation("ParentMainAccount");
                });

            modelBuilder.Entity("Edary.Entities.SubAccounts.SubAccount", b =>
                {
                    b.HasOne("Edary.Entities.MainAccounts.MainAccount", "MainAccount")
                        .WithMany()
